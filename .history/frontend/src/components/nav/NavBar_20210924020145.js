                    ...
                    <div className="column is-offset-5 navbar-end">
                        <div className="navbar-item">
                            <div className="buttons is-justify-content-center">
                                {/* <ProfileIcon /> */}
                                <div className="prof-icon dropdown is-align-items-center">
                                    <div className="level has-text-white dropdown-trigger" aria-haspopup="true" aria-controls="dropdown-menu2"> 
